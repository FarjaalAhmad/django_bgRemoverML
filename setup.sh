...
tar xvzf deeplabv3_mnv2_pascal_train_aug_2018_01_29.tar.gz -C mobile_net_model/model --strip=1

mkdir -p models/xception_model/model
tar xvzf deeplabv3_pascal_train_aug_2018_01_04.tar.gz -C xception_model/model --strip=1
